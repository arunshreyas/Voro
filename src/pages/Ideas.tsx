...
import { Heart, MessageCircle, Share2, Plus, Zap, FileText, Send, VolumeX, Volume2, Play, Pause } from 'lucide-react';
...
const Ideas = () => {
  ...
  const voroSparks = posts.filter(post => post.type === 'spark');
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="text-center mb-8 form-fade-in">
            ...
            <p className="text-muted-foreground text-lg">
              Connect, create, and collaborate with the community
            </p>
          </div>
          ...
          <Tabs defaultValue="posts" className="w-full">
            ...
            <TabsContent value="sparks" className="space-y-4">
              <PostFeed
                ...
                addComment={addComment}
                likePost={likePost}
                emptyMessage="No Voro Sparks yet. Share your first spark of inspiration!"
              />
            </TabsContent>
          </Tabs>
        </div>
